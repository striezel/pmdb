...
int main()
{
  //unordered list code test
  {
    ...
    std::cout << "Passed all unordered list code tests.\n";
  } //end of scope for unordered list tests
  ...
  //unordered list code test
  {
    ...
    while (iter != tests.end())
    {
      ...
      {
        std::cout << "Error: Some code was not transformed properly!\n"
                  << "Instance: ListBBCode(\"list\", false)\n"
                  << "Original text:   \""<<iter->first<<"\"\n"
                  << "Expected result: \""<<iter->second<<"\"\n"
                  << "Actual result:   \""<<text<<"\"\n";
        return 1;
    ...
    std::cout << "Passed all ordered list code tests.\n";
  } //end of scope for ordered list tests
