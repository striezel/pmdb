...
bool Encoding::UTF8_to_ISO_8859_1(const std::string& strUTF8, std::string& strISO)
{
...
bool Encoding::ISO_8859_1_to_UTF8(const std::string& strISO, std::string& strUTF8)
{
